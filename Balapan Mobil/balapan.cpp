...
int main()
{
 ...
 float fSpk = 0;
  while(spk <= 0)
  {
    system("cls");
    system("color a");
    tulisTengah("Balapan Mobil-Mobil an", 10);
    tulisTengah("==============================", 11);
	...
	tulisTengah("       Created by              ", 18);
	tulisTengah("       THOWUS AJMALIFANKA (A11.2019.11677)               ", 19);
    tulisTengah("            UNIVERSITAS DIAN NUSWANTORO                  ", 20);
